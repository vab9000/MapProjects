...
namespace processing {
    ...
    public:
        ...
        auto recalculate_sprite_coords(std::array<int_fast32_t, 2> offset, double_t zoom) -> void;
        ...
        auto update_map_texture(const uint8_t *bytes) -> void;

        // Update the map texture with new pixel data and position
        auto update_map_texture(const uint8_t *bytes, const sf::Vector2u &dimensions,
